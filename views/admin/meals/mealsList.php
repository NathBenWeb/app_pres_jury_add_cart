...
<div class="container">
    ...
    <h2 id="listTitle" class="text-center text-decoration-underline mb-4 mt-4">Liste des Menus</h2>
        ...
        <tbody>
            ...
            <?php if(is_array($meals)){ foreach ($meals as  $meal) { ?>
                ...
                <td class="text-center">
                    <a id="deleteBtn" class="btn" style="color:rgb(174,140,95); background-color:rgb(3, 3, 29);" href="index.php?action=edit_meal&id=<?= $meal->getId_meal();?>">
                        <i id="updateBtn" class="fas fa-pen"></i>
                    </a>
                </td>
                <?php if($_SESSION["Auth"]->id_g !=3){?> 
                <td  class="text-center">
                    <a id="deleteBtn" class="btn" style="color: red; background-color:rgb(3, 3, 29);" href="index.php?action=delete_meal&id=<?= $meal->getId_meal();?>"
